...
Either deploy your own homeserver or register an account on a [[https://www.hello-matrix.net/public_servers.php][public homeserver]] such as matrix.org. matrix-client-el doesn't currently support registration but you can use another client like [[https://riot.im/app/#/register][Riot to register for an account]].
